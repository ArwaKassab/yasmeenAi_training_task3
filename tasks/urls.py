...
from tasks.views import task_views ,scatter_gather_views , synchronous_views
...
urlpatterns = [
    ...
    path('no-scatter-gather/', synchronous_views.TaskSyncView.as_view(), name='task-scatter-gather'),
]
